...
export class CampeonesService {
  ...
  getCampeones(): Observable<Campeon[]> {
    return this.http.get<Campeon[]>( 'http://ddragon.leagueoflegends.com/cdn/11.23.1/data/es_ES/champion.json')
  }
  ...
  getCampeonPorId(id : string ): Observable<any> {
    return this.http.get<any>( `http://ddragon.leagueoflegends.com/cdn/11.23.1/data/es_ES/champion/${ id }.json`)
  }
